...
<div class="modal hide fade" id="modalEdit<?=$i?>" tabindex="-1" role="dialog" aria-labelledby="modalEdit<?=$i?>Label" aria-hidden="true">
  ...
  <div class="modal-body">
      <div class="row-fluid">
		<input type="hidden" name="kodeDosen" id="kodeDosen" value="<?=$data[$i][0]?>" required="required">
		...
		<div>
			...
			<label><p class="title">Username</p>
			  <input name="username" type="text" class="span12" value="<?=$data[$i][1]?>" required="required">
			</label>
			...
			<label><p class="title">Email</p>
			  <input name="email" type="email" class="span12" value="<?=$data[$i][4]?>" required="required">
			</label>
			<label><p class="title">Tempat Lahir</p>
			  <input name="tpl" type="text" class="span12" value="<?=$data[$i][7]?>" required="required">
			</label>
			<label><p class="title">Tanggal Lahir</p>
			  <input name="ttl" type="text" class="span12" value="<?=$data[$i][8]?>" required="required">
			</label>
			<label><p class="title">Alamat</p>
			  <input name="alamat" type="text" class="span12" value="<?=$data[$i][7]?>" required="required">
			</label>
		</div>
	  </div>
  </div>
