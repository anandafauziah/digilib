				...
				<div class="row-fluid">
					...
					<div>
						...
						<label>
							...
							<input name="judul" type="text" class="span12" value="<?= $data[$i][1] ?>" required="required">
						</label>
						<label>
		...
		<div class="modal-body">
			<div class="row-fluid">
				...
				<div>
					<label>
						<p class="title">Gambar</p>
						<!-- <input name="gambar" type="file" class="span12"> -->
						<input class="btn btn-success" type="file" name="image">
					</label>
					<label>
						<p class="title">Judul Buku</p>
